...
const AddRoomPage = () => {
    ...
    const addRoom = async () => {
        ...
        try {
            ...
            formData.append('photo', roomDetails.roomPhotoUrl);
    ...
    // https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4MHqRzVMbkb8FusNPuk8oKmN98vsq9U6i4w&s
    return (
        <div className="edit-room-container">
            ...
            <div className="form-group">
                    <label>Enter Room Url</label>
                    <input
                        type="text"
                        name="roomPhotoUrl"
                        value={roomDetails.roomPhotoUrl}
