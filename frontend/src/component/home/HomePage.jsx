        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/homepage.jpg" alt="Online Booking Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Papon Hotel Website</span>
                        </h1><br />
                        <h3>Step into a online world to book hotels</h3>
                    </div>
                </header>
            </section>
            ...
            <h4><a className="view-rooms-home" href="/rooms">Visit All The Rooms</a></h4>

            <h2 className="home-services">Services at <span className="phegon-color">Papon Hotel</span></h2>
