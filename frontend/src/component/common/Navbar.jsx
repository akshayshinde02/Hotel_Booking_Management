...
function Navbar() {
    ...
    return (
        <nav className="navbar">
            <div className="navbar-brand" style={{display:"flex",left:"0",gap:"0"}}>
                <img src='./assets/images/images.png' alt='logo' className='logo-papon'/>
                <NavLink to="/home" style={{marginTop:"4px"}}>Papon Hotel</NavLink>
            </div>
